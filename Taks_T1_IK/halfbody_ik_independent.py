...
if __name__ == "__main__":
    ...
    # 创建任务
    base_task = mink.FrameTask("base_link", "body", position_cost=1e4, orientation_cost=1e4, lm_damping=1.0)
    ...
    tasks = [base_task, posture_task] + list(ee_tasks.values())
    ...
    with mujoco.viewer.launch_passive(model, data, show_left_ui=False, show_right_ui=False) as viewer:
        ...
        base_task.set_target_from_configuration(cfg)
