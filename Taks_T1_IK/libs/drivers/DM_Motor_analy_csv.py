...
REVERSED_JOINTS = {1, 3, 4, 7, 11, 12, 18, 22, 23, 25, 27, 31, 32}
...
class MotorControl:
    ...
    def __init__(self, serial_device, log_dir="/home/taks-t1-controller/taks/logs/motor_logs"):
        """
